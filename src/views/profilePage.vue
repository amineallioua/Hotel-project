    ...
    <div class="w-full h-full  md:px-[65px] px-[30px] pt-[51px]  ">
        <div class=" flex justify-between mt-5 md:flex-row flex-col md-gap-0 gap-3  ">
            <div
                ...
                <p class=" absolute text-[#4796A9] font-[400] text-[10px] md:bottom-5 bottom-1 right-5 "> X Send message</p>
                ...
                <div class="  flex md:flex-row flex-col  gap-8 ">
                    ...
                    <div class="w-full flex flex-col gap-1 lg:pr-10 ">
                        ...
                        <p class=" text-[#729FAA] font-[400] lg:text-[10px] text-[8px] mt-1  ">Lorem Ipsum is simply dummy text of the
