        ...
        <div class=" flex flex-col gap-6 items-center md:w-1/2 w-full justify-center ">
            ...
            <div class=" flex flex-col gap-4 ">
                ...
                <button @click="register"
                    class="w-[247px] h-[41px] rounded-[10px] bg-custom-gradient font-[500] text-white text-[20px] shadow-form ">Sign
                    up</button>
            </div>
            
            <div class=" w-[35px] h-[35px] rounded-full bg-[#EDEDED] shadow-filter flex items-center justify-center  "><svg width="29" height="18" viewBox="0 0 29 29"
            ...
            <p class="text-[#4796A9D6] text-opacity-85 text-[10px] font-[400] ">have an account? <router-link
                    to="login"> <span class=" text-[#3A7A89] text-opacity-100 ">Log in</span> </router-link> </p>
        </div>
