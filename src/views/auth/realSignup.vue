    ...
    <div class="  w-full h-full flex   bg-[#CDCDCD1F] bg-opacity-10 " >
        ...
        <div class=" flex flex-col gap-6 items-center md:w-1/2 w-full justify-center " >
            ...
            <form class=" flex flex-col gap-4 " >
                ...
                <button class="w-[247px] h-[41px] rounded-[10px] bg-custom-gradient font-[500] text-white text-[20px] shadow-form " >Sign up</button>
            </form>
            <div class=" w-[35px] h-[35px] rounded-full bg-black  " ></div>
            <p class="text-[#4796A9D6] text-opacity-85 text-[10px] font-[400] " >have an account? <span class=" text-[#3A7A89] text-opacity-100 " >Log in</span> </p>
        </div>
