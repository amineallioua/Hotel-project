<template>
 <div class=" w-full h-full flex flex-col gap-[90px] justify-center items-center " >
    ...
    <div class=" flex items-center gap-[32px] z-10 " >
        <router-link to="/realsignUp" >
        <button class=" w-[239px] h-[123px] bg-custom-gradient rounded-[28px] font-[500] text-[30px] text-white " >Hotel owner</button>
        </router-link>    
        <h3 class=" font-[500] text-[22px] text-[#4796A9] " >or</h3>
        <router-link to="/realsignUp" >
        <button class=" w-[239px] h-[123px] bg-custom-gradient rounded-[28px] font-[500] text-[30px] text-white" >Customer</button>
        </router-link>    
    </div>
