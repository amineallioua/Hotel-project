<template>
    <div class=" relative flex flex-col justify-between items-center md:flex-row lg:w-[746px] md:w-[546px] w-1/2 h-1/2  md:h-[100px] p-4 gap-4 rounded-[19px] bg-white shadow-custom ">
        ...
        <div
            class=" w-full md:w-[210px] md:h-full bg-custom-gradient1 rounded-[14px] shadow-custom border-[1px] border-opacity-10 border-[#4796A91A] px-[15px] py-[9px] flex flex-col justify-center  gap-[10px] ">
        ...
        <router-link to="/search">
            <button
                class="  hidden absolute lg:w-[108px] md:w-[80px] h-[60px] rounded-[19px] bg-custom-gradient  lg:right-[-65px] md:right-[-40px] top-6 md:flex justify-center items-center ">
            ...
            <div class=" w-full flex justify-center " >
                <button
                class="  md:hidden  w-[108px]  h-[60px] rounded-[19px] bg-custom-gradient   flex justify-center items-center ">
                <svg width="44" height="35" viewBox="0 0 56 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M52.4832 22L53.8974 23.4142L55.3116 22L53.8974 20.5858L52.4832 22ZM2.48315 20C1.37859 20 0.483154 20.8954 0.483154 22C0.483154 23.1046 1.37859 24 2.48315 24V20ZM33.8974 43.4142L53.8974 23.4142L51.0689 20.5858L31.0689 40.5858L33.8974 43.4142ZM53.8974 20.5858L33.8974 0.585785L31.0689 3.41422L51.0689 23.4142L53.8974 20.5858ZM52.4832 20H2.48315V24H52.4832V20Z"
                        fill="white" />
