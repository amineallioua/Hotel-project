<template>
    <div class="flex-col md:w-auto w-[80%] md:flex-row lg:flex-col flex duration-700 ease-in-out  md:gap-5 gap-5 items-between p-[20px] h-[90%] md:h-fit lg:min-w-[220px] lg:max-w-[220px] bg-[#e5ecee] md:border-0 border-[1px] border-[#6ebacf]  md:z-0 z-10  lg:h-[95%] mt-3 absolute  md:sticky rounded-[20px] md:shadow-filter"
    :class="{ 'left-[0px]' : this.filter  , 'left-[-80%]' : !this.filter }">
      <button @click="openFilter" class=" flex justify-center items-center md:hidden absolute w-[40px] h-[40px] bg-[#96c7d4] top-[50%] right-[-25px] rounded-full " >
